...
const BentoLink = ({ github, demo, hover, gitlink }) => {
  return (
    <div className="top-icons-div  flex gap-2 justify-center items-center absolute z-20 p-3 bg-black right-0 top-0 rounded-bl-4xl  ">
      {gitlink && (
        <a
          className="p-3 cursor-pointer rounded-full bg-white-50 text-black flex items-center justify-center"
          href={github}
          target="_blank"
        >
          {" "}
      ...
      <a
        className="p-3 cursor-pointer rotate-45 rounded-full bg-white-50 text-black flex items-center justify-center"
        href={demo}
        target="_blank"
      >
        {" "}
